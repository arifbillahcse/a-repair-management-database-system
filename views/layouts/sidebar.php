...
<nav class="sidebar" id="sidebar" role="navigation" aria-label="Main navigation">
    ...
    <ul class="nav-list">
        ...
        <!-- Packing Lists (DDT) -->
        <li class="nav-item">
            <a href="<?= BASE_URL ?>/packing-lists" class="nav-link nav-link-packing <?= navActive('/packing-lists') ?>">
                <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                     stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
        ...
        <li class="nav-item has-sub <?= navActive('/reports|/sales/report') ?>">
            ...
            <ul class="sub-nav <?= navActive('/reports|/sales/report') ? 'open' : '' ?>">
                ...
                <li><a href="<?= BASE_URL ?>/reports/colleagues" class="sub-nav-link <?= navActive('/reports/colleagues') ?>">Colleague Performance</a></li>
            </ul>
        </li>
        <?php endif; ?>
