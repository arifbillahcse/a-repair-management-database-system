                ...
                <tr>
                    ...
                    <td>
                        <div class="act-btns">
                            ...
                            <a href="<?= BASE_URL ?>/invoices/<?= (int)$r['invoice_id'] ?>" class="act-btn" title="View invoice #<?= (int)$r['invoice_id'] ?>">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>
                            </a>
                            <?php elseif (!empty($r['actual_amount']) && (float)$r['actual_amount'] > 0): ?>
                            <form method="POST" action="<?= BASE_URL ?>/repairs/<?= $r['repair_id'] ?>/quick-invoice" class="il-form">
                                <input type="hidden" name="csrf_token" value="<?= Utils::e(Auth::generateCSRFToken()) ?>">
                                <button type="submit" class="act-btn" title="Create invoice">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="12" y1="18" x2="12" y2="12"/><line x1="9" y1="15" x2="15" y2="15"/></svg>
                                </button>
                            </form>
                            <?php else: ?>
                            <span class="act-btn" style="opacity:.35;cursor:not-allowed" title="Set Actual Amount first">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="12" y1="18" x2="12" y2="12"/><line x1="9" y1="15" x2="15" y2="15"/></svg>
                            </span>
                            <?php endif; ?>
