                ...
                <div class="card-body" style="display:flex;flex-direction:column;gap:1rem">
                    ...
                    <div class="form-group" style="margin-bottom:0">
                        ...
                        <select id="signature_id" name="signature_id" class="form-input">
                            ...
                            <option value="1" <?= ($fd['signature_id'] ?? 0) == 1 ? 'selected' : '' ?>><?= Utils::e($signatures['signature1']) ?></option>
                            <?php endif; ?>
                            <?php if (!empty($signatures['signature2'])): ?>
                            <option value="2" <?= ($fd['signature_id'] ?? 0) == 2 ? 'selected' : '' ?>><?= Utils::e($signatures['signature2']) ?></option>
                            <?php endif; ?>
                            <?php if (!empty($signatures['signature3'])): ?>
                            <option value="3" <?= ($fd['signature_id'] ?? 0) == 3 ? 'selected' : '' ?>><?= Utils::e($signatures['signature3']) ?></option>
                            <?php endif; ?>
                        </select>
                    </div>
                </div>
