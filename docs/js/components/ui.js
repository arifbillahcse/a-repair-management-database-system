...
const Icon = {
    ...
    tooth:     c => Icon._wrap('<path d="M12 5.5c-1.6-1.3-3.2-1.9-4.7-1.6C5.3 4.3 4 6.2 4 8.9c0 2 .4 3.6.9 5.3.4 1.3.6 2.6.8 4 .1 1.2.8 2 1.8 2 1.1 0 1.6-.9 1.9-2.3l.5-2.4c.2-1 .6-1.6 1.1-1.6h.1c.5 0 .9.6 1.1 1.6l.5 2.4c.3 1.4.8 2.3 1.9 2.3 1 0 1.7-.8 1.8-2 .2-1.4.4-2.7.8-4 .5-1.7.9-3.3.9-5.3 0-2.7-1.3-4.6-3.3-5-1.5-.3-3.1.3-4.7 1.6z"/>', c),
    car:       c => Icon._wrap('<path d="M5 17h14M6.5 17a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zM20.5 17a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0z"/><path d="M3 17v-3.2a2 2 0 0 1 .4-1.2l2.1-2.8A2 2 0 0 1 7.1 9h7.3a2 2 0 0 1 1.5.7l2.6 2.9a2 2 0 0 1 .5 1.3V17"/><path d="M6 12h12"/>', c),
    snowflake: c => Icon._wrap('<path d="M12 2v20M12 6l3.5-3.5M12 6 8.5 2.5M12 18l3.5 3.5M12 18l-3.5 3.5"/><path d="m3.3 7 17.4 10M7.5 8.2 6.4 3.4M7.5 8.2 2.8 9.5M16.5 15.8l1.1 4.8M16.5 15.8l4.7-1.3"/><path d="m20.7 7-17.4 10M16.5 8.2l1.1-4.8M16.5 8.2l4.7 1.3M7.5 15.8l-1.1 4.8M7.5 15.8l-4.7-1.3"/>', c),
    /** The current variant's mark — used for the brand lockup. */
    brand:     c => (Icon[VARIANT.icon] ?? Icon.wrench)(c),
