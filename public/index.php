...
// Reports
$router->get( '/reports/colleagues',       'ReportController@colleagueReport');
...
// Admin
$router->get(  '/admin/db-export',                   'AdminController@dbExportPage');
...
$router->post( '/admin/users/:id/rename',            'AdminController@renameUser');
